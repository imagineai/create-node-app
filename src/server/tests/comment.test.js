...
describe('Comment tests', () => {
  ...
  test('/PUT - Response with an updated comment', async () => {
    ...
    expect(new Date(data.submitted).toUTCString()).toEqual(otherFakeComment.submitted.toUTCString());
    ...
    expect(new Date(updatedComment.submitted).toUTCString()).toEqual(otherFakeComment.submitted.toUTCString());
  });
  ...
  test('/DELETE - Response with a deleted comment', async () => {
    ...
    const response = await request(app)
      .delete(`${ENDPOINT}/${ fakeComment.id }`);
